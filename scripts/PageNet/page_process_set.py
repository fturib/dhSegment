...
def find_page(img_filenames, dir_predictions, post_process_params, output_dir, debug=False):
    """
...
if __name__ == '__main__':
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        find_page(input_files, npy_directory, post_process_params, output_dir)
